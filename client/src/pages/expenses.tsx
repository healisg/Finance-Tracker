...
import { Heart, Gamepad2, Target, Users, User, ChevronDown, ChevronUp, Calendar, Tag } from "lucide-react";
...
export default function Expenses() {
  ...
  if (isLoading) {
    return (
      <div className="max-w-7xl mx-auto p-4 sm:p-8">
        <div className="text-center py-8 text-white/60">Loading expenses...</div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2 font-jakarta">Monthly Expenses</h1>
        <p className="text-white/60 font-geist">
          Track and review your spending across the three categories for better financial planning
        </p>
      </div>
